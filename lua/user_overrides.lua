...
local function any_file_exists(paths)
...
-- Avoid recursive scans of /usr during reload; they can exceed Hyprland's
-- Lua execution budget.
local function has_kvantum_qml_module()
  return any_file_exists({
    "/usr/lib/qt6/qml/kvantum/qmldir",
    "/usr/lib64/qt6/qml/kvantum/qmldir",
    "/usr/share/qt6/qml/kvantum/qmldir",
    "/usr/lib/qt6/qml/org.kde.kvantum/qmldir",
    "/usr/lib64/qt6/qml/org.kde.kvantum/qmldir",
    "/usr/share/qt6/qml/org.kde.kvantum/qmldir",
    "/usr/lib/qt5/qml/org.kde.kvantum/qmldir",
    "/usr/lib64/qt5/qml/org.kde.kvantum/qmldir",
    "/usr/share/qt5/qml/org.kde.kvantum/qmldir",
    "/usr/lib/qt5/qml/kvantum/qmldir",
    "/usr/lib64/qt5/qml/kvantum/qmldir",
    "/usr/share/qt5/qml/kvantum/qmldir",
  })
end

local function has_hyprland_qml_style_module()
  return any_file_exists({
    "/usr/lib/qt6/qml/org/hyprland/style/qmldir",
    "/usr/lib64/qt6/qml/org/hyprland/style/qmldir",
    "/usr/share/qt6/qml/org/hyprland/style/qmldir",
    "/usr/lib/qt5/qml/org/hyprland/style/qmldir",
    "/usr/lib64/qt5/qml/org/hyprland/style/qmldir",
    "/usr/share/qt5/qml/org/hyprland/style/qmldir",
  })
end
