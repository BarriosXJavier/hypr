...
local app_binds = {
  ...
  { "SUPER SHIFT", "Return", "$HOME/.config/hypr/scripts/Dropterminal.sh alacritty", "DropDown terminal" },
  {
    "SUPER ALT",
    "mouse_down",
...
bind("SUPER SHIFT", "U", exec_cmd("$HOME/.config/hypr/scripts/Toggle-Move-Special.sh special:special"), { description = "toggle move to special workspace" })
bind("SUPER", "U", dispatch("togglespecialworkspace", ""), { description = "toggle special workspace" })
bind("SUPER SHIFT", "Y", exec_cmd("$HOME/.config/hypr/scripts/Toggle-Move-Special.sh special:secondary"), { description = "toggle move to secondary special workspace" })
bind("SUPER", "Y", dispatch("togglespecialworkspace", "special:secondary"), { description = "toggle secondary special workspace" })
bind("SUPER SHIFT", "V", exec_cmd("$HOME/.config/hypr/scripts/Toggle-Move-Special.sh special:tertiary"), { description = "toggle move to tertiary special workspace" })
