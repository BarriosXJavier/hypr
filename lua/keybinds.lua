...
bind("SUPER SHIFT", "Y", dispatch("movetoworkspace", "special:secondary"), { description = "move to secondary special workspace" })
bind("SUPER", "Y", dispatch("togglespecialworkspace", "special:secondary"), { description = "toggle secondary special workspace" })
bind("SUPER SHIFT", "V", dispatch("movetoworkspace", "special:tertiary"), { description = "move to tertiary special workspace" })
